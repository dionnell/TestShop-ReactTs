                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div className="h-8 w-8 rounded-full bg-gray-900 flex items-center justify-center shrink-0 max-sm:h-5 max-sm:w-5">
                        <span className="text-white text-xs font-bold">
                          {user.fullName.split(" ").map((n) => n[0]).slice(0, 2).join("").toUpperCase()}
                        </span>
                      </div>
                      <span className="font-medium text-gray-900 truncate max-w-[70px] sm:max-w-[140px] max-sm:text-sm">
                        {user.fullName}
                      </span>
                    </div>
                  </TableCell>
